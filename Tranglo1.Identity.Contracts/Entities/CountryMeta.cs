...
namespace Tranglo1.Identity.Contracts.Entities
{
    public class CountryMeta : Enumeration
    {
        ...
        //public static IEnumerable<CountryMeta> GetNonSanctionCountriesAsync()
        //{
        //    return GetAllCountryMeta().Where(x => x.SanctionCount == false);
        //}
        ...
        public static readonly CountryMeta Moldova_Republic_of = new CountryMeta(146, "Moldova, Republic of", "MD", "MDA", "+377");
        public static readonly CountryMeta Monaco = new CountryMeta(147, "Monaco", "MC", "MCO", "+976");
        public static readonly CountryMeta Mongolia = new CountryMeta(148, "Mongolia", "MN", "MNG", "+382");
